...
def build_photo_ortho(tile, til_x_left,til_y_top,zoomlevel,provider_code,out_file_name=''):
    ...
    if O4_ESP_Globals.build_for_FSX_P3D or O4_ESP_Globals.build_for_FS9:
        ...
        O4_ESP_Utils.make_ESP_inf_file(final_file_dir, final_file_name, til_x_left, (til_x_left + nbr), til_y_top, (til_y_top + nbr), zoomlevel, O4_ESP_Globals.build_for_FS9)
