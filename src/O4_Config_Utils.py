...
too low to grab these details.",
    ...
    'ESP_resample_loc': {
        ...
        'default':'',
        'hint':
        'Enter the location to your resample.exe'
    },
    'ESP_scenproc_loc': {
        'type':str,
        'default':'',
        'hint':'Enter the location to your scenProc.exe'
    },
    'ESP_scenproc_script': {
        'type':str,
        'default':'default.spc',
        'hint':'Enter the file inside the ScenProc_configs folder to use for ScenProc'
    },
    'max_resample_processes': {
        'type':int,
        'default':8,
        'hint':'The max amount of resample processes to spawn'
    },
    'create_ESP_night': {
        'type':bool,
        'default': False,
        'hint':'Whether to create night textures for ESP'
    },
    'create_ESP_summer': {
        'type':bool,
        'default': False,
        'hint':'Whether to create summer textures for ESP'
    },
    'create_ESP_spring': {
        'type':bool,
        'default': False,
        'hint':'Whether to create spring textures for ESP'
    },
    'create_ESP_fall': {
        'type':bool,
        'default': False,
        'hint':'Whether to create fall textures for ESP'
    },
    'create_ESP_winter': {
        'type':bool,
        'default': False,
        'hint':'Whether to create winter textures for ESP'
    },
    'create_ESP_hard_winter': {
        'type':bool,
        'default': False,
        'hint':'Whether to create hard_winter textures for ESP'
    }
}
